...
public class BuyerTestCases {
    ...
    public static Stream<Arguments> invalidControllerRegistrationCases() {
        return Stream.of(
                ...
                Arguments.of("Email is invalid", new RegisterBuyerRequest(VALID_FIRST_NAME, VALID_LAST_NAME, "invalid-email", VALID_PASSWORD, VALID_PHONE, VALID_ADDRESS_REQUEST), HttpStatus.BAD_REQUEST, "Invalid E-mail"),
