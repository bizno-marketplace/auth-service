package com.biznopay.authservice.usecase.auth.confirmAccount;
...
public class ConfirmAccountTests {
    ...
    @Test
    @DisplayName("Should throw InvalidConfirmationTokenException when accessToken is not found")
    ...
    @Test
    @DisplayName("Should throw ExpiredConfirmationTokenException if accessToken has expired")
    ...
    @Test
    @DisplayName("Should active user and mark activation accessToken as used")
