...
public class ResendConfirmationTests {
    ...
    @Test
    @DisplayName("Should publish email event, delete older accessToken if exists, start cooldown and return successfully message")
    ...
    @Test
    @DisplayName("Should publish email event, not delete older accessToken when not exists, start cooldown and return successfully message")
