Feature: Register Seller
  ...
  Scenario Outline: Attempt to register with invalid or missing fields
    ...
    Examples:
      ...
      | João      | Tembe    | not-an-email         | +258841234567 | Segura@123 | Tembe Electronics | Venda de electrónica e acessórios | -25.9692 | 32.5732   | Av. 24 de Julho | Sommerschield | Maputo | Maputo   | Mozambique | 400123456 | 422        | Invalid E-mail                                                                                                                                     |
